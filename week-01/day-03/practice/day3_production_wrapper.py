...
# # Triggering Permanent Error
# llm_client = ProductionLLMClient(model="gpt-4o-mini-typo")
# llm_client_response = llm_client.chat([
#         {'role': 'system', 'content': "You are a helpful assistent."},
#         {'role': 'user', 'content': "What's sum of 2+2, one word answer"}

#     ])
# print(llm_client_response.choices[0].message.content)

# Triggering Transient Error
...
llm_client_response = llm_client.chat([
        {'role': 'system', 'content': "You are a helpful assistent."},
        {'role': 'user', 'content': "What's sum of 2+7, one word answer"}
...
llm_client_response = llm_client.chat([
        {'role': 'system', 'content': "You are a helpful assistent."},
        {'role': 'user', 'content': "What's sum of 2+9, one word answer"}
